...
<head>
    ...
    <title>Recettes pour la Salle de Bain</title>
    <link rel="stylesheet" href="cuisine.css">
</head>
<body>
    <div class="recipes-container">
        <h1 class="recipes-title">Produits Maison pour la Salle de Bain</h1>
        <p class="recipes-description">Découvrez nos recettes pour des produits écologiques et naturels à utiliser dans votre salle de bain.</p>
        ...
        <?php } else { ?>
            <p class="recipes-empty">Aucune recette disponible pour la salle de bain.</p>
        <?php } ?>
    </div>
    <?php $conn->close(); ?>
</body>
